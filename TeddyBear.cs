...
namespace GameProject
{
    ...
    public class TeddyBear
    {
        ...
        /// <param name="TeddyBounce">the sound the teddy bear plays when bouncing</param>
        ...
        public TeddyBear(ContentManager contentManager, string spriteName, int x, int y,
            Vector2 velocity, SoundEffect TeddyBounce, SoundEffect shootSound)
        {
            LoadContent(contentManager, spriteName, x, y);
            this.velocity = velocity;
            this.TeddyBounce = TeddyBounce;
        ...
        {
            // move the teddy bear
            drawRectangle.X += (int)(velocity.X * gameTime.ElapsedGameTime.Milliseconds); drawRectangle.Y += (int)(velocity.Y * gameTime.ElapsedGameTime.Milliseconds);
